...
import com.lambdaschool.anywherefitness.models.CartItem;
import com.lambdaschool.anywherefitness.models.Product;
import com.lambdaschool.anywherefitness.models.User;
import com.lambdaschool.anywherefitness.repositories.CartRepository;
import com.lambdaschool.anywherefitness.repositories.ProductRepository;
        ...
        implements CartService
{
    ...
    public Cart save(Cart cart, Product product) {
        ...
        if (helperFunctions.isAuthorizedtoMakeChange(cart.getUser().getUsername())) {
